...
One could say _bubble_, _selection_ and _insertion_ sort are the elementary sorting algorithms, and they are generally not the most performant (except for some specific niches).

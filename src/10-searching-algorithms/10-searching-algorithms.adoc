...
An array of 64 elements would take 6 steps at most, as stem:[2^6 = 32].
...
[source,typescript,linenums]
----
include::./binary-search-num/indexOf.test.ts[]
----
...
[source,typescript,linenums]
----
include::./naive-string-search/countSubstrs.test.ts[]
----

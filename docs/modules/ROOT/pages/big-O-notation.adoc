...
For example, if the input for a given function is 5, and there are five recursive invocations, time complexity is not stem:[O(n)] just because the function is recursively called five times and added five times to the call stack.
Only the space required for storing temporary and return data is to be taken into account.
...
[source,js]
----
include::example$src/02-big-O-notation/sum.test.ts[]
----
...
[source,ts]
----
include::example$src/02-big-O-notation/sum-v1.ts[]
----
...
[source,ts]
----
include::example$src/02-big-O-notation/sum-v2.ts[]
----
...
[source,ts]
----
include::example$src/02-big-O-notation/sum-v3.ts[]
----

== calcSubtotals(xs) example

=== Unit Tests

[source,ts]
----
include::example$src/02-big-O-notation/calcSubtotals.test.ts[]
----
...
[source,ts]
----
include::example$src/02-big-O-notation/calcSubtotals-v1.ts[]
----
